...
export default function Loading() {
  return (
    <main className="min-h-screen bg-gray-50/50 dark:bg-gray-950 font-serif text-gray-900 dark:text-gray-100 py-8 md:py-12 animate-pulse">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm space-y-6">
            
            {/* Image Skeleton - Matches 3:4 mobile & 4:5 desktop ratio */}
            <div className="w-full aspect-[3/4] sm:aspect-[4/5] min-h-[380px] max-h-[650px] bg-gray-200 dark:bg-gray-800/80 rounded-xl" />
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white dark:bg-gray-900 p-6 sm:p-8 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm space-y-4">
              {/* Full Name Skeleton */}
              <div className="h-9 sm:h-10 bg-gray-300 dark:bg-gray-700 rounded-lg w-3/4" />
              ...
              <div className="pt-2 border-t border-gray-100 dark:border-gray-800 flex gap-4">
                <div className="h-5 bg-gray-200 dark:bg-gray-800/70 rounded-md w-28" />
                <div className="h-5 bg-gray-200 dark:bg-gray-800/70 rounded-md w-28" />
              </div>
            </div>
            ...
            {/* About Me Card */}
            <div className="bg-white dark:bg-gray-900 p-6 sm:p-8 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm space-y-4">
              <div className="h-6 bg-gray-300 dark:bg-gray-700 rounded-md w-24 border-b border-gray-100 dark:border-gray-800 pb-3" />
            ...
            <div className="bg-white dark:bg-gray-900 p-6 sm:p-8 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm space-y-4">
              <div className="h-6 bg-gray-300 dark:bg-gray-700 rounded-md w-28 border-b border-gray-100 dark:border-gray-800 pb-3" />
              
              <div className="space-y-3 pt-1">
                <div className="flex items-center gap-4">
                  <div className="h-5 bg-gray-300 dark:bg-gray-700 rounded-md w-20" />
                  <div className="h-5 bg-gray-200 dark:bg-gray-800 rounded-md w-1/2" />
                </div>
                <div className="flex items-center gap-4">
                  <div className="h-5 bg-gray-300 dark:bg-gray-700 rounded-md w-28" />
