        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {[...Array(8)].map((_, i) => (
              <div 
                key={i} 
                className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden shadow-sm p-4 space-y-3"
              >
                {/* Image Skeleton */}
                <div className="w-full h-64 bg-gray-200 dark:bg-gray-800/80 rounded-xl"></div>
                ...
                <div className="h-4 bg-gray-200 dark:bg-gray-800/60 rounded-md w-2/3"></div>
              </div>
            ))}
          </div>
        </div>
