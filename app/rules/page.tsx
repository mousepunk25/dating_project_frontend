...
export const metadata: Metadata = {
  title: 'Regulamin korzystania z portalu',
};

export default function RulesPage() {
  return (
    <main className="min-h-screen bg-slate-50 flex flex-col justify-center items-center p-4 sm:p-6 md:p-8">
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden flex flex-col my-8">
        
        {/* Header */}
        <header className="p-6 sm:p-8 border-b border-slate-100 text-center">
        ...
        {/* Rules Content */}
        <div className="p-6 sm:p-8 space-y-8 text-sm sm:text-base text-slate-700 leading-relaxed">
